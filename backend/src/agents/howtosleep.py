    ...
    *,
    ...
    if knowledge:
        toolkit.register_tool_function(
            ...
            func_description="搜索睡眠改善领域的知识库。当用户询问专业知识、方法、技巧时使用。",
        )
        toolkit.register_tool_function(
            knowledge.add_knowledge_to_user,
            func_description="将重要的睡眠经验添加到个人知识库。仅在用户分享有价值的经验、笔记时使用。",
        )
    
    bundle = build_chat_model(llm)
    
    # 使用绝对路径加载 prompt
    prompt_path = _PROMPTS_DIR / "howtosleep.system.md"
